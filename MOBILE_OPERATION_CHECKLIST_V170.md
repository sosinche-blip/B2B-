...
모바일 브라우저는 PC 로컬 폴더를 직접 열 수 없습니다. 현재 V170는 PC/Ncloud 서버의 발주폴더를 보조 API로 읽어 모바일에서 목록·다운로드를 지원합니다. 완전 클라우드 파일 보관이 필요하면 다음 단계에서 Supabase Storage 또는 Ncloud Object Storage 연동이 필요합니다.
