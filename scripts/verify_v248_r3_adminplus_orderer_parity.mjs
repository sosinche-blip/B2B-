...
if(app){must(app.includes('const UI_RELEASE_REVISION = "V248 R3";'),"UI release is V248 R3");must(app.includes("주문자 소신채/010-6880-9413 고정"),"UI explains fixed orderer policy")}
