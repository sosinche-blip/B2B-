...
if(app){must(app.includes('const UI_RELEASE_REVISION = "V248 R4";'),"UI release retains V248 R3+ orderer policy");must(app.includes("주문자 소신채/010-6880-9413 고정"),"UI explains fixed orderer policy")}
