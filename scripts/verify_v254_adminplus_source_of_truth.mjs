...
check("V254+ header version", /const\s+UI_RELEASE_REVISION\s*=\s*["\']V(?:25[4-9]|2[6-9]\d|[3-9]\d\d)[^"\']*["\']/.test(app));
...
check("V254+ package release", /0\.1\.0-v(?:25[4-9]|2[6-9]\d|[3-9]\d\d)/.test(String(pkg.version)));
