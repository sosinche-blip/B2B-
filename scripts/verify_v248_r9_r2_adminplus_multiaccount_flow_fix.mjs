...
if(app){must(app.includes("reconcileAdminPlusRules(adminplusAccounts, nextBase)"),"server save persists all loaded AdminPlus account rules");must(/UI_RELEASE_REVISION = \"(?:V248 R9\.(?:2|3|4|5)|V249 R10)\"/.test(app),"V248 R9.2+ UI marker");}
