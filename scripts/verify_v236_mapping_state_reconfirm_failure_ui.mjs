...
if(app){
  must(/const UI_RELEASE_REVISION = "V248 R(?:[2345678]|7\.1|8\.1)"/.test(app) && app.includes('const APP_VERSION = `${UI_RELEASE_REVISION}'),"header follows current release revision");
