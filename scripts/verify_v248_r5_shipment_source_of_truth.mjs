...
if(app) pass("UI release retains V248 R5+ shipment policy", app.includes('UI_RELEASE_REVISION = "V248 R5"') || app.includes('UI_RELEASE_REVISION = "V248 R6"') || app.includes('UI_RELEASE_REVISION = "V248 R7"') || app.includes('UI_RELEASE_REVISION = "V248 R7.1"'));
