...
if(app){must(/const UI_RELEASE_REVISION = "V248 R[23]";/.test(app),"UI release retains V248 R2+ hotfix line");must(app.includes("AdminPlus") && app.includes("주문자"),"UI explains current AdminPlus orderer hotfix")}
