...
const checks = [
  [app.includes('V201 운영현황·발주·쿠폰구조 개선본'), "V201 화면에서 V200 쿠폰 생명주기 기능 유지"],
  ...
  [app.includes('coupon-workflow-section') && app.includes('24시간 관리에 아직 없는 기존 쿠폰'), "연관 기능 그룹 배치"],
  [app.includes('coupon-list-actions') && app.includes('선택 항목을 24시간 관리에 추가'), "기존 쿠폰 목록 바로 아래 작업 버튼"],
