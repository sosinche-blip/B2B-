...
check(app.includes('APP_VERSION = "V200 쿠폰 실행흐름·취소확인 개선본"'), "V200 version marker");
...
check(worker.includes('v200-coupon-workflow-lifecycle'), "V200 Worker marker");
console.log("[PASS] V200 mapping compatibility and Excel-only workflow verification completed");
