# DEPLOYMENT GUIDE V175_ATTACHMENT_REBASE_DEPLOY_READY

## 1. 목적
V175는 새 기능 확장보다 모바일 실운영 시 헷갈리는 실행경로, IP, 환경변수, 임시 Tunnel 위험을 화면에서 분리해 확인하도록 보강한 버전입니다.
